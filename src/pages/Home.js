    ...
    return (
        <div className={`${darkToggle && 'dark'}`}>
            <div className='dark:bg-slate-700'>
                ...
                <div className='container mx-auto py-16 px-4 dark:bg-slate-700 dark:text-white'>
                    <h1 className="text-5xl font-bold text-dark bg-white dark:bg-slate-700 text-center mb-6 p-4 rounded-lg">Why Join Us</h1>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="card w-100 bg-base-100 dark:bg-slate-700 shadow-xl">
