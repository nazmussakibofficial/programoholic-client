...
const Blog = () => {
    return (
        <div className='blog-bg pt-8'>
            <div class='flex items-center justify-center min-h-screen'>
                <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
                    <h1 class="text-xl mb-10 text-center">Some Questions & Answers</h1>

                    <details class="w-full bg-white border border-green-500 cursor-pointer mb-3">
                        <summary class="w-full bg-white text-dark flex justify-between px-4 py-3  after:content-['+']">What is CORS?</summary>
                        <p class="px-4 py-3">
